#!/usr/bin/python
#
# The purpose of this script is to add a list of users from a CSV to a specific branch
# in TalentLMS.
# 
...
count = 0
for i in user_id:
    url = base_url + '/addusertobranch/user_id:' + user_id[count] + ",branch_id:" + branch_id
